package com.kchmielewski.sda.java.spring03java.data.player.web;

import com.kchmielewski.sda.java.spring03java.data.player.service.PlayerService;
...
public class PlayerControllerTest {
    ...
    public void display() throws Exception {
        ...
        softly.assertThat(service.findAll()).hasSize(0);
        softly.assertAll();
    }
    ...
    public void add() throws Exception {
        ...
        softly.assertThat(service.findAll()).hasSize(1);
        softly.assertAll();
    }

//    @Test
//    public void remove() throws Exception {
////        service.create(new Player("Abc", "Def"));
//
